...
export class MinistryService {
  ...
  constructor(private httpclient:HttpClient) {}
    ...
    declineapplication(id:number):Observable<any>{
      console.log("inside service"+id)
      const body = {appid:id}
      return this.httpclient.put<any>(this.url+'ScholarshipApproval/RejecteByMinistry/'+id,body)
    }
    ...
    declineInsapplication(id:number):Observable<any>{
      console.log("inside service"+id)
      const body = {appid:id}
      return this.httpclient.put<any>(this.url+'InstituteApproval/RejectRequesteByMinistry/'+id,body)
    }
